...
public class play2 {
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        ...
        dispatcher.register(literal("play2").executes(ctx -> playSong1(ctx.getSource())));
    }

    private static int playSong1(FabricClientCommandSource source) {


        songControls.play(songControls.song2);
        source.sendFeedback(Text.translatable("timm.commands.play2", songControls.nowPlaying()));
